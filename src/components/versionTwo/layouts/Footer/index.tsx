			...
			<Container maxW="6xl">
				...
				>
					<div className="flex items-center justify-center gap-4 mb-4 text-slate-500">
						<span className="text-slate-500 hover:text-[#E1306C] transition-colors">
							<a
						...
						<span className="text-slate-500 hover:text-[#0077B5] transition-colors">
							<a
						...
						<span className="text-slate-500 hover:text-[#34A853] transition-colors">
							<a
								href="https://maps.google.com/?q=Lagos,Nigeria"
								target="_blank"
								rel="noopener noreferrer"
								className="text-slate-500 hover:text-[#34A853] transition-colors"
